...
# cualquier cantidad de espacios), asi que el MATCH extraido tampoco lo
# tiene. Un match gigante puede por si solo topar el cap de 2000 del helper
# y comerse el "commit" -- la misma brecha, otra puerta. Si el match excede
# la ventana, se conserva cabeza+cola (NO solo el principio): el fragmento
# que informa vive al FINAL del match, truncar solo por delante lo tiraria.
