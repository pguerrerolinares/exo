...
- [ ] Preguntas de una en una; si un tema necesita más, se parte en varias preguntas — §Checklist ítem 3 (línea 27) + líneas 72-73 ("Only one question per message") + §Key Principles (línea 135)
...
- [ ] Cobertura del diseño: arquitectura, componentes, data flow, error handling, testing — línea 87
